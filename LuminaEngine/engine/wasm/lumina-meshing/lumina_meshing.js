/* @ts-self-types="./lumina_meshing.d.ts" */
...
export class MeshData {
     ...
     */
    get groups() {
        const ret = wasm.meshdata_groups(this.__wbg_ptr);
     ...
     */
    get normals() {
        const ret = wasm.meshdata_normals(this.__wbg_ptr);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
     ...
     */
    get positions() {
        const ret = wasm.meshdata_positions(this.__wbg_ptr);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
     ...
     */
    get uvs() {
        const ret = wasm.meshdata_uvs(this.__wbg_ptr);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
}
if (Symbol.dispose) MeshData.prototype[Symbol.dispose] = MeshData.prototype.free;
 ...
 * @param {Uint8Array} is_transparent
 * @param {Uint16Array} top_material
 * @param {Uint16Array} bottom_material
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./lumina_meshing_bg.js": import0,
    };
}

const MeshDataFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_meshdata_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('lumina_meshing_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
